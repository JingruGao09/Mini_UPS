    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('package_status', models.CharField(choices=[('CREATED', 'CREATED'), ('TRUCK EN ROUTE TO WAREHOUSE', 'TRUCK EN ROUTE TO WAREHOUSE'), ('TRUCK WAITING FOR PACKAGE', 'TRUCK WAITING FOR PACKAGE'), ('OUT FOR DELIVERY', 'OUT FOR DELIVERY'), ('DELIVERED', 'DELIVERED')], default='CREATED', help_text='Package Status', max_length=20)),
            ],
            options={
                'db_table': 'package',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('truck_status', models.CharField(choices=[('IDLE', 'IDLE'), ('EN ROUTE TO A WAREHOUSE', 'EN ROUTE TO A WAREHOUSE'), ('ARRIVED WAREHOUSE', 'ARRIVED WAREHOUSE'), ('DELIVERING', 'DELIVERING'), ('WAITING FOR PICKUP', 'WAITING FOR PICKUP'), ('INVAILD', 'INVAILD')], default='IDLE', help_text='Truck Status', max_length=20, null=True)),
            ],
            options={
                'db_table': 'truck',
            },
